		...
		<form action="DoneBook" method="post">
			...
			<table class="table">
				...
				<tbody>
					...
					<tr>
						<th>ISBN番号</th>
						<td><c:out value="${isbn}" /><input type="hidden"
							name="isbn" value="${isbn}">
					</tr>
					<tr>
						<th>資料名</th>
						<td><c:out value="${name}" /><input type="hidden"
					...
					<tr>
						<th>著者</th>
						<td><c:out value="${author}" /><input type="hidden"
							name="author" value="${author}"></td>
					</tr>
					<tr>
						<th>出版社</th>
						<td><c:out value="${publisher}" /><input type="hidden"
							name="publisher" value="${publisher}"></td>
					</tr>
					<tr>
						<th>出版日</th>
						<td><c:out value="${publishedDay}" /><input type="hidden"
							name="publishedDay" value="${publishedDay}"></td>
					</tr>
					<c:if test="${action.equals('insert')}">
						<tr>
							<th>入荷冊数</th>
							<td><c:out value="${number}" /><input type="hidden"
