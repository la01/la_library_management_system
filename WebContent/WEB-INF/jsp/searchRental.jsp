	...
	<div class="page-content-wrapper">
		...
		<form action="SearchRental" method="post">
			<div class="row">
				<div class="col-xs-2">
					<label for="memberId">会員ID</label> <input type="text"
						class="form-control" id="memberId" autocomplete="off">
				</div>
				<div class="col-xs-2">
					<label for="bookId">資料ID</label> <input type="text"
						class="form-control" id="bookId" autocomplete="off">
				</div>
				<div class="col-xs-2">
					<label for="bookName">ISBN番号</label> <input type="text"
			...
			<div class="row">
				...
				<div class="col-xs-2">
					<div class="checkbox">
						<label><input type="checkbox" value="notReturned"
							id="notReturned">未返却</label>
					</div>
				</div>
			</div>
			<div class="row">
