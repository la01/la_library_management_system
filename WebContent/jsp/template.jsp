...
<nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
  <div class="container-fluid">
    ...
    <c:if test="${!empty login}">
      ...
      <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="sidebar-icon">
                <i class="fa fa-users"></i>
              </span>会員 <span class="caret"></span></a>
      ...
      <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="sidebar-icon">
              ...
              </span>資料 <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li>
      ...
      <li class="dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="sidebar-icon">
              ...
              </span>レンタル <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li>
